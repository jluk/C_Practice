...
/* Given to you for free, However you better know 
how to do this come time for the final exam */
...
/* A function pointer type that points to a function 
that takes in a void* and returns nothing, call it 
list_op */
typedef void (*list_op)(void*);
/* A function pointer type that points to a function 
that takes in a const void* and returns an int, call 
it list_pred */
typedef int (*list_pred)(const void*);
/* A function pointer type that points to a function 
that takes in a void* and returns a void*, call it 
list_cpy */
